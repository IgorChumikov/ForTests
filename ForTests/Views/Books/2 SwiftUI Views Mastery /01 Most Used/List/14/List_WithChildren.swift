...
/*
 List — иерархический список с children (iOS 14+)

 • List(parents, children: \.children) автоматически создаёт outline-представление,
   когда элементы содержат вложенные массивы таких же объектов.
 • children: — key path, указывающий, где искать дочерние элементы.
 • SwiftUI сам добавляетDisclosure-индикаторы и поддерживает раскрытие/сворачивание секций.
 • Подходит для отображения иерархий: папки, категории, сотрудники, структуры данных.
 • Никакой дополнительной логики не требуется — вложенность строится автоматически.
 */
